...
// 弾のクラス
//*****************************************************************************
class CBullet03 : public CScene2D
{
public:																			// 誰でもアクセス可能
	CBullet03(int nPriority = PRIORITY_SECOND);									// コンストラクタ
	~CBullet03();																	// デストラクタ
																				// メンバ関数
	static CBullet03 *Create(D3DXVECTOR3 pos, D3DXVECTOR3 move, D3DXVECTOR2 Size, int nAttack);	// 弾の生成
