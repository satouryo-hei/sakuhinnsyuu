...
public:																// 誰でもアクセス可能
	...
	~CStage_Tutorial();												// デストラクタ
																	// メンバ関数
	static CStage_Tutorial *Create(D3DXVECTOR3 pos);					// ゲームの選択の生成
	...
	static CNoneBlock*GetEnemy(void) { return *m_pNone; }						// 空のポインターを取得
...
private:															// 自分だけがアクセス可能
	...
	static CNoneBlock * m_pNone[128];								// noneブロックのポインター
