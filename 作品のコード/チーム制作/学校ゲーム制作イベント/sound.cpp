...
CSound::CSound()
{
	...
	for (int nConut = 0; nConut < SOUND_LABEL_MAX; nConut++)
	{
		m_apSourceVoice[nConut] = NULL;			// ソースボイス
		m_apDataAudio[nConut] = NULL;			// オーディオデータ	
	}
}
...
HRESULT CSound::Init(HWND hWnd)
{
	...
	{
		{ "data/BGM/bgm.wav", -1 },						// 戦闘ぽいBGM
		{ "data/BGM/bgm00.wav", -1 },					// ヒーリングBGM
		{ "data/BGM/bgm000.wav", -1 },					// うるさいBGM
		{ "data/BGM/Summer_fog.wav", -1 },				// 自然の音に近いBGM
		{ "data/BGM/Summer_expedition.wav", -1 },		// ファンタジーなBGM
		{ "data/BGM/bgm004.wav", -1 },					// サンプルBGM
		{ "data/SE/shot000.wav", 0 },					// ショット音
		{ "data/SE/bom000.wav", 0 }						//爆発音
	};
