...
public:
	...
	CCircle_Effect(PRIORITY nPriority = CBilleffect::PRIORITY_NOMAL);														// コンストラクタ
	~CCircle_Effect();																										// デストラクタ
	static CCircle_Effect *Create(D3DXVECTOR3 pos, D3DXVECTOR3 move, D3DXVECTOR3 size, D3DXCOLOR col, CTexture::Tex type,	// 生成
	...
	void Update(void);																										// 更新
	void Draw(void);																										// 描画
	void SetCircle(D3DXVECTOR3 pos, D3DXVECTOR3 move, D3DXVECTOR3 size, D3DXCOLOR col, CTexture::Tex type,					// 設定
		 D3DXVECTOR3 addmove, D3DXVECTOR3 addsize, D3DXCOLOR addcol, int nRadius,int nDensity, int nLife);					 
