...
// コンストラクタ
//=============================================================================
CChoose_Game::CChoose_Game(PRIORITY Priority) :CScene(PRIORITY_UI), ResetCol(D3DXCOLOR(1.0f, 1.0f, 1.0f, 0.5f)), m_fInterval(200.0f)
{
	m_bFade = true;
...
void CChoose_Game::Update(void)
{
	...
	case CHOOSE_NEWGAME:
		...
		//m_pEffect->SetColor(D3DXCOLOR(1.0f, 0.0f, 0.0f, 1.0f), CEffect::POLYGON_BEFORE);
