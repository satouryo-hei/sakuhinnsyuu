...
// 2Dオブジェクトの生成処理
//=============================================================================
CScene2D *CScene2D::Creste(D3DXVECTOR3 pos, D3DXVECTOR2 size, int nTex)
{
	// ポリゴンのポインター生成
...
//=============================================================================
// 2Dオブジェクトの大きさと現在位置の更新処理
//=============================================================================
void CScene2D::SetUpdatePosSize(D3DXVECTOR3 pos, D3DXVECTOR2 Size)
{
	//頂点情報へのポインタ
	VERTEX_2D*pVtx;
